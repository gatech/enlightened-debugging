...
public abstract class FieldInstruction extends DependencyTrackingInstruction implements ReadOrWriteInstruction {
  ...
  public static DynamicDependency getFieldDependency(
  		ElementInfo eiFieldOwner, FieldInfo fieldInfo) {
  	return (DynamicDependency) eiFieldOwner.getFieldAttr(fieldInfo);
  }
  
  public static void setFieldDependency(
  		ElementInfo eiFieldOwner, FieldInfo fieldInfo, DynamicDependency dep) {
  	eiFieldOwner.setFieldAttr(fieldInfo, dep);
  }
}
