...
public class ATHROW extends DependencyTrackingInstruction implements JVMInstruction {

  @Override
  public Instruction execute (ThreadInfo ti) {
    StackFrame frame = ti.getModifiableTopFrame();

    Object objAttr = frame.getOperandAttr();
    int objref = frame.pop();
    
  	DynamicDependency exDep = DynDepBuilder.newBuilder()
  			.appendDataDependency(objAttr, getInstructionDepSource(ti))
    ...
    return ti.throwException(objref, exDep);
  }
