...
public class EXECUTENATIVE extends DependencyTrackingInstruction implements JVMInstruction {
  ...
  public String toString() {
    ...
    if (executedMethod != null){
      sb.append(executedMethod.getFullName());
    } else {
    	sb.append("(missing method info)");
    }
